...
//    {
//        entity.health++;
//        if (!world.transformPlant(entity, scheduler, imageStore))
//        {
...
//            Entity miner = world.createDudeFull(entity.id,entity.position
//                    , entity.actionPeriod,
...
//            ImageStore imageStore)
//    {
//        Entity miner = world.createDudeNotFull(entity.id,entity.position,
//                entity.actionPeriod,
//                entity.animationPeriod,
//                entity.resourceLimit,
//                entity.images);
...
//        {
//            return world.transformTree(entity, scheduler, imageStore);
//        }
...
//    {
//        if (entity.health <= 0) {
//            Entity stump = world.createStump(entity.id,
//                    entity.position,
...
//        {
//            Entity tree = world.createTree("tree_" + entity.id,
//                    entity.position,
...
//            Entity entity = world.createDudeNotFull(properties[DUDE_ID],
//                    pt,
...
//            Entity entity = world.createFairy(properties[FAIRY_ID],
//                    pt,
...
//            Entity entity = world.createTree(properties[TREE_ID],
//                    pt,
...
//            Entity entity = pt.createHouse(properties[HOUSE_ID],
//                    imageStore.getImageList(
//                            HOUSE_KEY));
//            world.tryAddEntity( entity);
//        }
...
//            return Optional.of(ImageStore.getCurrentImage(world.getBackgroundCell( pos)));
//        }
//        else {
//            return Optional.empty();
//        }
